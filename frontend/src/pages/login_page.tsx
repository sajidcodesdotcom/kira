...
export default function LoginPage() {
    ...
    return (
        <>
            <div className="m-auto w-full max-w-md p-8 h-screen grid place-items-center">
                <div className="bg-white rounded-xl w-full shadow-2xl overflow-hidden">
                    <div className="p-8">
                        <h1 className="text-3xl font-semibold text-gray-800 text-center mb-6">Welcome Back</h1>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="space-y-5">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        type="button"
                                        className="absolute right-0 top-1/2 flex items-center pr-3 text-gray-500"
                                    ...
                                    >
                                        {showPassword ? (
                                            ...
                                            /* Hide password icon (eye crossed out) */
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
